const coalesce = (value, fallback) => value && value.length > 0 ? value : fallback;
export const buildProviderRequest = (params) => {
    ...
    if (providerKey === "google") {
        const baseUrl = coalesce(params.provider.apiBaseUrl, "https://generativelanguage.googleapis.com");
        const chatPath = coalesce(params.provider.chatPath, `/v1beta/models/${params.model}:generateContent`);
